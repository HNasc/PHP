...
<body>
    <div class="modal fade" id="EdicaoUsuarioModal<?php echo $result['IdProduto']; ?>" role="dialog">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header bg-primary">
                    <button type="button" class="close" data-dismiss="modal">&times;</button>
                    <h4 class="modal-title"><center>Alterar meus dados:</center></h4>
                </div>
                <div class="modal-body">
                    <form action='Alteracao/EditUsuario.php' enctype="multipart/form-data" method='post'>
